Ext.define('pbs-cloud-backup-job-status', {		// changed to cloud
    ...
    proxy: {
	type: 'proxmox',
	url: '/api2/json/cloud/backup',		// changed to cloud
    },
});

Ext.define('PBS.config.CloudBackupJobView', {		// changed Tape to Cloud
    extend: 'Ext.grid.GridPanel',
    alias: 'widget.pbsCloudBackupJobView',			// changed Tape to Cloud

    stateful: true,
    stateId: 'grid-cloud-backup-jobs-v1',			// changed Tape to Cloud

    title: gettext('Cloud Backup Jobs'),				// changed Tape to Cloud
	...
	addJob: function() {
	    let me = this;
	    Ext.create('PBS.CloudManagement.BackupJobEdit', {		// changed Tape to Cloud
		autoShow: true,
		listeners: {
		    destroy: function() {
			me.reload();
	...
	runJob: function() {
		...
		method: 'POST',
		url: `/cloud/backup/${id}`,				// changed Tape to Cloud
	...
	rstore: {
	    type: 'update',
	    storeid: 'pbs-cloud-backup-job-status',
	    model: 'pbs-cloud-backup-job-status',
	    interval: 5000,
	},
    },
	...
	},
	{
	    ...
	    baseurl: '/config/cloud-backup-job/',
