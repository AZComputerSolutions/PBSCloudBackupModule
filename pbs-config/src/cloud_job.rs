...
pub fn upload_backup_to_sia(client: &SiaClient, file_path: &str) -> Result<(), SiaError> {
    client.upload_file(file_path)
}

pub fn download_backup_from_sia(client: &SiaClient, file_id: &str, destination: &str) -> Result<(), SiaError> {
...
pub fn save_config(config: &SectionConfigData) -> Result<(), Error> {
    ...
    upload_backup_to_sia(&sia_client, CLOUD_JOB_CFG_FILENAME)?;
